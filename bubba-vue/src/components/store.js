...
const collections = [
  { 
    ...
    products: [
      ...
      colors: ['pinkMatte', 'lightblueMatte', 'lightvioletMatte', 'blackMatte', 'yellow', 'lightblue', 'pink', 'black'],
      colorImages: {
        'pinkMatte': [],
        'lightblueMatte': [],
        'lightvioletMatte': [],
  ...
  { 
    ...
    products: [
      ...
      colors: ['pink', 'green', 'black', 'violet'],
      colorImages: {
        'pink': [],
        'green': [],
        'black': [],
...
//       imageUrl: 'Victoria/victoriap2.png', 
//       colors: ['pink', 'green', 'black', 'violet'],
//       images: [/* ruta de las imágenes 3D aquí */] },
//     ]
//   },
//   { 
//     id: 3, 
